...
public class LoggingAdvice {
	...
	@AfterReturning(pointcut = "execution(* com.student.management.*.*.*(..) )", 
			   returning = "retVal")
	public void afterReturningAdvice(JoinPoint jointPoint, Object retVal){
		Signature method=jointPoint.getSignature();
		String value=retVal.toString();
		logger.info("Method signature : {}", method);
